...
namespace gradepenalty_reattemptmaxscore\privacy;
...
/**
 * Privacy Subsystem for gradepenalty_reattemptmaxscore implementing null_provider.
 *
...
class provider implements
    ...
    public static function get_contexts_for_userid(int $userid): contextlist {
        $sql = "SELECT ctx.id
                  FROM {gradepenalty_reattemptmaxscore_rule} gdr
    ...
    public static function export_user_data(approved_contextlist $contextlist): void {
        ...
        $rules = $DB->get_records('gradepenalty_reattemptmaxscore_rule', ['usermodified' => $user->id]);
        $data = (object) $rules;

        // Write out the data.
        writer::with_context(\context_user::instance($user->id))->export_data([
            get_string('privacy:metadata:gradepenalty_reattemptmaxscore_rule', 'gradepenalty_reattemptmaxscore'),
            'rules',
        ], $data);
    }
    ...
    public static function get_metadata(collection $collection): collection {
        $collection->add_database_table(
            'gradepenalty_reattemptmaxscore_rule',
            [
                'usermodified' => 'privacy:metadata:gradepenalty_reattemptmaxscore_rule:usermodified',
              ],
            'privacy:metadata:gradepenalty_reattemptmaxscore_rule'
        );
        return $collection;
    }
    ...
    protected static function delete_user_data(int $userid): void {
        ...
        $DB->set_field_select('gradepenalty_reattemptmaxscore_rule', 'usermodified', 0,
